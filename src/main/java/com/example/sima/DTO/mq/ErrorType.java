...
@XmlType(name = "ErrorType", namespace = "http://modernisc.com/api/csd", propOrder = {
    "code",
    "message",
    "errorParams"
})
public class ErrorType {
    ...
    @XmlElement(name = "Code", namespace = "http://modernisc.com/api/csd", required = true)
    protected String code;
    @XmlElement(name = "Message", namespace = "http://modernisc.com/api/csd", required = true)
    protected String message;
    @XmlElement(name = "ErrorParams", namespace = "http://modernisc.com/api/csd")
